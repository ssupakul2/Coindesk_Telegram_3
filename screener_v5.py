...
def calculate_signal_score(rsi, bounce_info, candle_info, vol_confirmed, in_fibo_zone, in_ob_zone, in_fvg_zone, weekly_ctx, mtf_info, adx, is_divergence, trend_info, onchain_info, funding_info=None, oi_info=None) -> tuple[int, str]:
    # 1. Technical Score
    ...
    for coin in COINS:
        ...
        if signal_type and coin not in positions:
            ...
            sig_score, score_label = calculate_signal_score(
                ...
                funding_info=funding_info, oi_info=oi_info,
            )
            ...
            if sig_score >= MINIMUM_SIGNAL_SCORE:
                ...
                # Funding/OI advisory notes (non-blocking warnings)
                advisory_lines = []
