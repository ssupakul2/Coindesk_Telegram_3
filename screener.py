...
def get_historical_data(coin: str) -> pd.DataFrame | None:
    ...
    # ทางเลือกที่ 2: (Bypass Engine) สลับมาใช้ Public Global Aggregator พร้อมล้างข้อมูลให้อยู่ในฟอร์แมตบอท
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            if res_json.get("Response") == "Success" and "Data" in res_json:
                ...
                # แปลงเวลาและคัดกรองข้อมูลให้ตรงสเปกอินดิเคเตอร์ของระบบเดิม
