...
# ==========================================
API_RATE_LIMIT_DELAY = 0.3    # Binance public: 1200 req/min = ok with 0.3s
API_MAX_RETRIES      = 3
BINANCE_LIMIT        = 500
...
# TF-aware aliases: code uses _4H/_1D variants; aliases defined here
...
DATA_STALENESS_SKIP_HOURS_1D = 50.0
...
def scan_market(positions: dict):
    ...
    # Phase 3: On-chain disabled in v10 (no API key required)
    all_onchain = {}  # stub: returns empty, get_onchain_data handled per-coin
