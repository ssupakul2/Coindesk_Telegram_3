...
# [B] Binance Endpoints (สลับ .us และ .vision ขึ้นบนสุดเพื่อ GitHub Actions)
BINANCE_ENDPOINTS = [
...
def is_volume_confirmed(row: pd.Series) -> bool:
    # หากข้อมูลมาจาก Source ที่ไม่มี Volume (เช่น CoinGecko) ให้ถือว่าผ่าน เพื่อไม่ให้เสียคะแนน Signal Score
    ...
    for coin in COINS:
        ...
        if signal_type:
            ...
            if sig_score >= MINIMUM_SIGNAL_SCORE:
                ...
                # คำนวณ Correlation กับ BTC แบบไดนามิก
                corr_btc = 0.5
